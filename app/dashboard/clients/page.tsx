        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-5">
          ...
          <div className="overflow-x-auto overflow-y-auto max-h-[500px] border border-gray-200 rounded-lg">
            <table className="w-full text-sm text-left border-collapse">
              <thead className="sticky top-0 bg-[#f0f4f8] text-gray-700 border-b border-gray-200 font-semibold z-10">
                <tr>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-2 pr-12 border border-gray-300 rounded focus:ring-2 focus:ring-[#1c5ba9]/50 focus:border-[#1c5ba9] transition-colors outline-none text-sm font-medium"
                      placeholder="••••••••"
                    />
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#1c5ba9]"
                    >
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex gap-3 w-full mt-6">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold transition-colors"
                >
                  Cancel
                </button>
                ...
                <button
                  onClick={async () => {
                    await handleDeleteClient(deleteClientId);

                    setDeleteClientId(null);
                    setDeleteClientName("");
                  }}
                  disabled={deletingId === deleteClientId}
                  className="flex-1 py-2.5 rounded-lg bg-red-500 hover:bg-red-600 text-white font-bold transition-colors flex items-center justify-center gap-2 disabled:opacity-70"
                >
                  {deletingId === deleteClientId ? (
                    <>
                      <Loader2 size={16} className="animate-spin" />
                      Deleting...
                    </>
